...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"demo.MainWindow"))
    {
        return winrt_make_demo_MainWindow();
    }

    if (requal(name, L"demo.XamlMetaDataProvider"))
    {
        return winrt_make_demo_XamlMetaDataProvider();
    }
