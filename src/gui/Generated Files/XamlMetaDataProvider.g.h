...
namespace winrt::demo::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, demo::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = demo::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"demo.XamlMetaDataProvider";
        }
    };
}
namespace winrt::demo::factory_implementation
{
    ...
    {
        using instance_type = demo::XamlMetaDataProvider;
